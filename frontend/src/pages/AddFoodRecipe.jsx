...
export default function AddFoodRecipe() {
    ...
    const onHandleSubmit=async(e)=>{
        ...
        await axios.post("https://food-recipe-app-backend-c1mo.onrender.com/recipe",recipeData,{
            headers:{
            ...
            <div className='container'>
                <form className='form' onSubmit={onHandleSubmit}>
                    ...
                    <div className='form-control'>
                        ...
                        <textarea type='text' className='input-textarea' name='instructions' onChange={onHandleChange} required></textarea>
                    </div>
